...
public class RegisterUser {
	...
	public static void main(String[] args) throws Exception {
		...
		HFCAClient caClient = HFCAClient.createNewInstance("https://159.122.183.221:32686", props);
		...
		if (wallet.get("appUser1") != null) {
			System.out.println("An identity for the user \"appUser1\" already exists in the wallet");
			return;
		}
